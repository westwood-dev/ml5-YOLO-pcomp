...
(function () {
    ...
    async selectPort() {
      ...
      if (1 <= arguments.length) {
        if (Array.isArray(arguments[0])) {
          ...
          filters = arguments[0];
        } else if (this.isSerialPort(arguments[0])) {
    ...
    pull(controller) {
      (async () => {
        ...
        try {
          ...
          if (
            (_a = result.data) === null || _a === void 0 ? void 0 : _a.buffer
          ) {
  ...
  class SerialPort {
    ...
    constructor(device, polyfillOptions) {
      this.polyfillOptions_ = Object.assign(
        Object.assign({}, kDefaultPolyfillOptions),
        polyfillOptions
      );
      this.outputSignals_ = {
    ...
    get readable() {
      ...
      if (!this.readable_ && this.device_.opened) {
        this.readable_ = new ReadableStream(
          ...
          {
            highWaterMark:
              (_a = this.serialOptions_.bufferSize) !== null && _a !== void 0
                ? _a
                : kDefaultBufferSize,
          }
        );
    ...
    reconfigure(options) {
      this.serialOptions_ = Object.assign(
        Object.assign({}, this.serialOptions_),
        options
      );
      this.validateOptions();
    ...
    async setSignals(signals) {
      this.outputSignals_ = Object.assign(
        Object.assign({}, this.outputSignals_),
        signals
      );
      if (
    ...
    validateOptions() {
      ...
      if (!this.isValidDataBits(this.serialOptions_.dataBits)) {
        throw new RangeError(
          'invalid dataBits ' + this.serialOptions_.dataBits
        );
      }
      if (!this.isValidStopBits(this.serialOptions_.stopBits)) {
        throw new RangeError(
          'invalid stopBits ' + this.serialOptions_.stopBits
        );
      }
    ...
    async setLineCoding() {
      ...
      view.setUint8(
        ...
        kStopBitsIndexMapping.indexOf(
          (_a = this.serialOptions_.stopBits) !== null && _a !== void 0
            ? _a
            : kDefaultStopBits
        )
      );
      view.setUint8(
        5,
        kParityIndexMapping.indexOf(
          (_b = this.serialOptions_.parity) !== null && _b !== void 0
            ? _b
            : kDefaultParity
        )
      );
      view.setUint8(
        6,
        (_c = this.serialOptions_.dataBits) !== null && _c !== void 0
          ? _c
          : kDefaultDataBits
      );
